...
export default function PrismHeroVisual() {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex gap-2.5 overflow-x-auto border-b border-[var(--frenem-border)] pb-3 font-sans text-[10px] font-medium text-[var(--frenem-ink-tertiary)] sm:gap-4 sm:text-xs [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
        <span className="relative shrink-0 pb-3 font-medium text-[var(--frenem-ink)] after:absolute after:inset-x-0 after:-bottom-[13px] after:h-0.5 after:bg-[var(--frenem-accent)]">
          Org Chart
        </span>
      ...
      <div className="grid min-h-0 flex-1 grid-cols-2 gap-2 sm:gap-4">
        <div className="flex flex-col items-center justify-center gap-2 rounded-lg bg-[var(--frenem-bg-soft)] p-2 sm:p-4">
        ...
        <div className="flex min-w-0 flex-col gap-2 rounded-lg bg-[var(--frenem-bg-soft)] p-2 sm:gap-2.5 sm:p-4">
          <div className="mb-1 font-sans text-[10px] font-semibold uppercase tracking-[0.05em] text-[var(--frenem-ink-tertiary)] sm:text-[11px]">
            Q1 KRAs · A. Rao
          </div>
...
function KraRow({
  ...
  return (
    <div className="grid min-w-0 grid-cols-[1fr_auto] items-center gap-1.5 font-sans text-[10px] sm:gap-2 sm:text-xs">
      ...
      <div className="h-1.5 w-[48px] overflow-hidden rounded-full bg-[var(--frenem-border)] sm:w-[60px]">
        <motion.div
