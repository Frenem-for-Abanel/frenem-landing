...
const INK_TERTIARY = "var(--color-ink-tertiary)"
...
export default function PulseNetworkVisual() {
  ...
  const tr = (transition: Transition): Transition =>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between gap-2 border-b border-line pb-3 font-sans text-[11px] font-medium text-ink-tertiary sm:text-xs">
      ...
      <div className="min-h-0 flex-1">
        ...
        >
          <g style={{ stroke: INK }} strokeOpacity="0.18" strokeWidth="1.5">
            {ENERGY_TIES.map((tie, i) => (
              <motion.line
                ...
                transition={tr({ duration: 0.6, delay: tie.delay, ease: "easeOut" })}
                x1={tie.x1}
                x2={tie.x2}
                y1={tie.y1}
                y2={tie.y2}
          ...
          <g style={{ stroke: TINT }} strokeOpacity="0.85" strokeWidth="1.8">
            {BROKER_TIES.map((tie, i) => (
              <motion.line
                key={`b-${i}`}
                animate={show ? { pathLength: 1, opacity: 1 } : { pathLength: 0, opacity: 0 }}
                initial={{ pathLength: 0, opacity: 0 }}
                transition={tr({ duration: 0.7, delay: tie.delay, ease: "easeOut" })}
                x1={tie.x1}
                x2={tie.x2}
                y1={tie.y1}
                y2={tie.y2}
          ...
          <motion.line
            ...
            transition={tr({ duration: 0.6, delay: 1.4, ease: "easeOut" })}
            x1={150}
            x2={312}
            y1={172}
            y2={164}
          ...
          <g style={{ fill: INK }}>
            {NODES.map((node, i) => (
              <motion.circle
                ...
                transition={tr({ duration: 0.48, delay: node.delay, ease: EASE_POP })}
              />
            ))}
          </g>
          ...
          <motion.circle
            ...
            r={16}
            style={{ fill: TINT, transformBox: "fill-box", transformOrigin: "center" }}
            transition={
              show && !reduceMotion
          ...
          <motion.circle
            ...
            r={8}
            style={{ fill: TINT, transformBox: "fill-box", transformOrigin: "center" }}
            transition={tr({ duration: 0.48, delay: 0.9, ease: EASE_POP })}
          />
          ...
          <motion.circle
            ...
            transition={tr({ duration: 0.48, delay: 1.3, ease: EASE_POP })}
          />
          <motion.circle
            ...
            strokeWidth="1"
            style={{ stroke: INK_TERTIARY }}
            transition={tr({ duration: 0.6, delay: 1.5, ease: "easeOut" })}
          />
          ...
          >
            ...
            <motion.text
              ...
              initial={{ opacity: 0 }}
              textAnchor="middle"
              transition={tr({ duration: 0.6, delay: 1.6, ease: "easeOut" })}
              x={231}
              y={196}
            >
              Friction
            ...
            <motion.text
              animate={show ? { opacity: 1 } : { opacity: 0 }}
              initial={{ opacity: 0 }}
              transition={tr({ duration: 0.6, delay: 1.7, ease: "easeOut" })}
              x={70}
              y={240}
            >
              Isolated
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2 font-sans text-[9px] font-semibold uppercase tracking-[0.08em] text-ink-tertiary sm:gap-5 sm:text-[10px]">
        ...
        <span className="inline-flex items-center gap-1.5">
          <span className="w-[18px] border-t-2 border-dashed border-ink-tertiary" />
          Friction
        </span>
        <span className="inline-flex items-center gap-1.5">
