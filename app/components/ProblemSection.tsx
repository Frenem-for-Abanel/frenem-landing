    ...
    >
      <div className="container-v2">
        <div className="mb-12 grid grid-cols-1 items-end gap-8 md:mb-20 md:gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <Reveal delay={0.06}>
            <div className="rounded-xl border border-[var(--frenem-border-strong)] bg-[var(--frenem-bg)] p-6 md:p-8">
              <div className="mb-2 font-sans text-[48px] font-semibold leading-none tracking-[-0.04em] text-[var(--frenem-accent)] md:text-[64px]">
                1
              </div>
        ...
        <div className="grid grid-cols-1 border-l border-t border-[var(--frenem-border-strong)] md:grid-cols-2">
          {pains.map((pain, i) => (
            <Reveal key={pain.title} delay={0.03 * i}>
              <div className="flex cursor-default flex-col gap-3 border-r border-b border-[var(--frenem-border-strong)] bg-[var(--frenem-bg)] p-6 transition-colors duration-300 hover:bg-[var(--frenem-bg-soft)] md:gap-4 md:p-10">
                <span className="font-sans text-[13px] font-medium tracking-[0.02em] text-[var(--frenem-ink-tertiary)]">
                  {pain.num}
                </span>
                <h3 className="font-sans text-xl font-semibold leading-tight tracking-[-0.02em] md:text-2xl">{pain.title}</h3>
